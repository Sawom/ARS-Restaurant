        ...
        <div >
            <div className=' footer-center'>
                <footer style={{backgroundColor: '#111827'}} className="footer p-10 bg-neutral text-neutral-content">
                    {/* 1st part */}
                    <div>
                        <p> <span className='text-2xl font-bold' >CONTACT US</span> <br/> <br /> <span> 123 ABS Street, Uni 21, Bangladesh <br /> +88 123456789 <br /> Mon - Fri: 08:00 - 22:00 <br /> Sat - Sun: 10:00 - 23:00 </span> </p>
                    </div> 
                    {/* 2nd part */}
                    <div >
